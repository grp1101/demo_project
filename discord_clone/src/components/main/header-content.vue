...
<button type="button" class="btn" v-on:click="login()" style="background-color: #FFFFFF; border-radius: 20px;">
...
<br>
<br>
<div id="subtext">...학교 동아리, 게임 그룹, 세계 예술 감상 커뮤니티에 소속되어 유대감을 느낄 수 있는 공간. 소중한 단짝 친구들과 어울릴 수 있는 우리만의 공간. 더 쉽게, 매일 어울리고 이야기할 수 있는 그런 공간 말이에요.</div>
<br>
<br>
<button type="button" class="btn" style="background-color: #FFFFFF; border-radius: 20px;font-size: 20px;">Windows용 다운로드</button>
<button type="button" class="btn" style="background-color: #000000; border-radius: 20px; color:white;font-size: 20px;">웹브라우저에서 Discord 열기</button>
</div>
</template>
